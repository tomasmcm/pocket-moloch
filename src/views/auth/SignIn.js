...
const SignIn = ({ history }) => {
  ...
  return (
    <div>
      ...
      <Modal isShowing={isShowing.signInMsg} hide={() => toggle('signInMsg')}>
        ...
        <p>
          Thank you for creating an account. If you would like to join the DAO
          as a member, go to the twitter, telegram, or discord and find a
          current member to sponser you.
        </p>
        <h3>Important!</h3>
        <p>
          This app will not work in private mode. If you are using private mode
          in your browser please turn it off.
        </p>
        <h3>Some Notes:</h3>
        <p>
          This DAO uses contract wallets which are owned by your device keys. If
          you sign out of this device, you will no longer be able to access your
          wallet from this device.
        </p>
        <p>
          Make sure you have added at least one secondary device to access your
          wallet. With another approved device, you can always reapprove this
          device again.
        </p>
        <p>
          If you do choose to sign out and have not added any other device keys,
          you will not be able to access your wallet in the future. EVER!
        </p>
        <Link
          className="AltOption"
          to="/proposals"
